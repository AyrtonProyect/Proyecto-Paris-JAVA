 ...
 */
public class bebida_fact extends javax.swing.JInternalFrame {
    ...
    String comparar(String cod)
    {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM bebida WHERE codigo_bebida='"+cod+"'");
            while(rs.next())
            {
                cant=rs.getString(4);
            }
            ...
            Logger.getLogger(bebida_fact.class.getName()).log(Level.SEVERE, null, ex);
        }
        return cant;
   ...
   void mostrarbebida(String valor)
    {
        String[]titulos={"Codigo","Clasificacion","Descripcion","Precio"} ;  
        String []Registros= new String[4];
        modelo=new DefaultTableModel(null,titulos);
        String Sql="SELECT * FROM bebidas WHERE CONCAT(codigo_bebida,clasificacion,descripcion) LIKE '%"+valor+"%'";
        ...
        try {
             ...
             while(rs.next())
             {
                 Registros[0]=rs.getString("codigo_bebida");  
    ...
    private void initComponents() {
        ...
        tbbebida.setComponentPopupMenu(jPopupMenu1);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(14, 14, 14)
                        .addComponent(txtbus, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
...
// TODO add your handling code here:
    ...
    int  fila = tbbebida.getSelectedRow();
    ...
    {
        String codins=tbbebida.getValueAt(fila, 0).toString();
        String clains=tbbebida.getValueAt(fila, 1).toString();
        String desins=tbbebida.getValueAt(fila, 2).toString();
        String preins=tbbebida.getValueAt(fila, 3).toString();
        int c=0;
        int j=0;
